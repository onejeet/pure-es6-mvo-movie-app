...
//  Task to clean old css before generating new css - useful if we change file structure.
gulp.task('clean:styles', function () {
     return gulp.src('/dist/*.css', {read: false})
         .pipe(clean());
 });
 
 //  Task to clean old js before generating new js - useful if we change file structure.
